...
const AddProduct = () => {
  ...
  return (
    <section
      id="addProduct"
      className="min-h-screen bg-gradient-to-b from-slate-200 via-slate-400 to-slate-900 flex items-center justify-center px-4 mt-24"
    >
      <div className="bg-purple-50 rounded-2xl shadow-lg max-w-md w-full p-8 ">
